...
root@HNCWIN11:~# helm -n open-telemetry-infra-dev install ol-infra-dev open-telemetry/opentelemetry-collector --set mode=statefulset -f https://raw.githubusercontent.com/svdang999/Logging/main/opentelemetry/opentelemetry-collector-values.yaml
NAME: ol-infra-dev
